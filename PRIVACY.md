...
When running locally via `npx @ansvar/norwegian-energy-regulation-mcp`, all database queries stay on your machine. The only external data flow is between the MCP client and the AI provider (e.g., Anthropic).
...
- **Tool responses**: Regulation text, grid code content, decision summaries
...
- **General regulatory research**: Safe to use through any deployment -- regulation text is public information
- **Client-specific queries**: If your queries could reveal confidential business information (e.g., specific utility compliance gaps), consider using the local npm package
...
For privacy questions: https://github.com/Ansvar-Systems/norwegian-energy-regulation-mcp/issues
