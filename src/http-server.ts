...
const TOOLS = [
  {
    ...
    description:
      "Search across Norwegian energy regulations from NVE, RME, and DSB.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query in Norwegian or English" },
        regulator: {
          type: "string",
          enum: ["nve", "rme", "dsb"],
  ...
  },
  {
    ...
    description: "Search Statnett grid codes (FOSA/FOS), balancing rules, and capacity allocation.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Search RME network tariff decisions, revenue caps, and market methodology approvals.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query" },
...
const SearchRegulationsArgs = z.object({
  ...
  regulator: z.enum(["nve", "rme", "dsb"]).optional(),
  type: z.enum(["lov", "forskrift", "veiledning", "retningslinje"]).optional(),
      ...
      switch (name) {
        ...
        case "no_energy_about": {
          ...
          return textContent({
            ...
            version: pkgVersion,
            description:
              "Norwegian energy regulation MCP. Covers NVE, RME, Statnett, DSB.",
