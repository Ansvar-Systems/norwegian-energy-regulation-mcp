/**
 * SQLite database access layer for the Norwegian Energy Regulation MCP server.
 *
 * Schema covers four Norwegian energy regulators:
 *   - regulations      — NVE lover/forskrifter, DSB safety rules
 *   - grid_codes       — Statnett grid codes (FOSA/FOS), balancing rules
 *   - decisions        — RME tariff decisions, revenue caps, methodologies
 *
